// --------------------------------------------------------------
// @@@BUILDINFO@@@ CreateObjectBrowser.jsx 1.14 Sat May 31 2014 18:12:07 GMT+0300
...
CreateObjectBrowser = (function() {
    #include "../../../SimpleUI/src/UIImage/imageconverts.jsx"
    ...
    //~         }
        ...
        function _buildTree () {
            ...
            t.image = createImage(icons._class()); 
            ...
            for (i=0, maxp = prop.length; i<maxp; i++) {
                ...
                try {
                     ...
                     if  (hrefObj.reflect.find(p).type == 'readwrite') {
                        t.items[i].image =  createImage(icons._prop_rw());
                    } else {
                        t.items[i].text = prop[i] + " (Read only)";
                        t.items[i].image = createImage(icons._prop_ro());
                    }
                } catch (e) {
                        t.items[i].image = createImage(icons._prop_ro());
                }
            ...
            for (i=0, maxf = func.length; i<maxf; i++) {
                t.add ( "item", func[i]);
                t.items[i+maxp].image = createImage(icons._method()); 
            }
            func.length = 0;
            ...
            for (i=0; i<func.length; i++) {
                ...
                t.items[i+maxp + maxf].image = createImage(icons._method_static()); 
            }
            t.expanded = true;
